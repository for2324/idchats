...
cd ${sdk_server_binary_root}
  nohup ./${sdk_server_name}  -openIM_ws_address ${ws_address}  -sdk_ws_port ${sdk_ws_ports[0]} -openIM_api_address ${api_address} -openIM_log_level ${logLevel} >> ../logs/openIM.log 2>> ../logs/error.log &
#  nohup ./${sdk_server_name}   -openIM_api_port 10002 -openIM_ws_port 10001  -sdk_ws_port ${sdk_ws_ports[0]}  -openIM_log_level ${logLevel} >> ../logs/openIM.log 2>> ../logs/error.log &
