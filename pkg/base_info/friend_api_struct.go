...
type FollowAddFriendResp struct {
	CommResp
	PublicUserInfo []*open_im_sdk.PublicUserInfo
...
type FollowListUserInfo struct {
	open_im_sdk.PublicUserInfo
	Group *open_im_sdk.GroupInfo `json:"group"`
}
type GetFollowListRsp struct {
	CommResp
	PublicUserInfo []*open_im_sdk.PublicUserInfo `json:"-"`
	Data           []FollowListUserInfo          `json:"data"`
}

type GetUserFollowingListReq struct {
	OperationID string `json:"operationID" binding:"required"`
	// UserId      string `json:"userID" binding:"required"`
	PageIndex int32 `json:"pageIndex" default:"0"`
	PageSize  int32 `json:"pageSize" binding:"required" default:"20"`
}
type GetUserFollowingListResp struct {
	CommResp
	Data []open_im_sdk.PublicUserInfo `json:"data"`
}
