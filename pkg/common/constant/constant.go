...
const (
	...
	FriendFollowApplicationNotification       = 1210
	FriendFollowDeleteApplicationNotification = 1211
	FriendNotificationEnd                     = 1299
	ConversationOptChangeNotification         = 1300 // change conversation opt

	UserNotificationBegin       = 1301
	UserInfoUpdatedNotification = 1303 //SetSelfInfoTip             = 204
	UserAnnouncement            = 1304
	...
	GroupChannelInfoAdd                      = 1519
	GroupChannelInfoUpdate                   = 1520
	GroupChannelInfoDiss                     = 1521
	...
	ConversationMonitorForGroupNotification = 1703
	...
	BindTelephoneNumber               = 3
	ChangeTelePhoneCode               = 4
	BindTelePhoneNumber               = "_bindPhone"
	ChangeTelePhoneNumber             = "_changePhone"
	...
	RewardTypeTask = "TaskReward"

	// task
	TaskTypeDaily         = "Daily"
	TaskTypeTimeProgress  = "TimeProgress"
	TaskTypeCountProgress = "CountProgress"

	TaskStatusOpen  = 0
	TaskStatusClose = 1

	TaskIDBindTwitter                         = 1
	TaskIDInviteBindTwitter                   = 8
	TaskIDInviteFollowOfficialTwitter         = 9
	TaskIDNFTHeadDailyChatWithNewUser         = 4
	TaskIDOfficialNFTHeadDailyChatWithNewUser = 7
	TaskIDFollowOfficialTwitter               = 3
	TaskIDDailyCheckIn                        = 11
	TaskIdOpenWholeNetworkPush                = 12
	TaskIdJoinOfficialSpace                   = 13
	TaskIdCreateSapce                         = 14
	TaskIdUploadOfficialNftHead               = 15
	TaskIdUploadNftHead                       = 16
	TaskIdInviteUploadNftHead                 = 17

	UserTaskStatusNoStart  = 0
	UserTaskStatusDoing    = 1
	UserTaskStatusFinished = 2
	UserTaskStatusClaimed  = 3
	UserTaskStatusExpired  = 4

	RegisterEnsOrderStatusUnpaid         = "Unpaid"
	RegisterEnsOrderStatusPaid           = "Paid"
	RegisterEnsOrderStatusRegisterFailed = "RegisterFailed"
	RegisterEnsOrderStatusConfirmed      = "Confirmed"
	RegisterEnsOrderStatusRefund         = "Refund"
	RegisterEnsOrderStatusExpired        = "Expired"
	// RegisterEnsOrderStatusFailed = "Failed"

	PayScanBlockTaskETHType            = "ETH"
	PayScanBlockTaskMaticType          = "MATIC"
	PayScanBlockTaskBNBType            = "BNB"
	PayScanBlockTaskOPType             = "OP"
	PayScanBlockTaskZKSType            = "ZKS"
	PayScanBlockTaskARBType            = "ARB"
	PayScanBlockTaskMaticErc20USDTType = "ERC20_MATIC_USDT"

	PayScanBlockTaskStatusDoing    = 0
	PayScanBlockTaskStatusFinished = 1
	PayScanBlockTaskStatusConfirm  = 2
	PayScanBlockTaskStatusExpired  = 3
	PayScanBlockTaskStatusNotified = 4

	PayMarkPushSpaceArticleType = "push_space_article"
)
...
const LogFileName = "logs-open-im"
