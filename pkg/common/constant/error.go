...
var (
	...
	ErrKafka                 = ErrInfo{ErrCode: 813, ErrMsg: "kafka error"}

	ErrDoubleAppointment   = ErrInfo{ErrCode: 910, ErrMsg: "double appointment"}
	ErrHaveBeenAppointment = ErrInfo{ErrCode: 409, ErrMsg: "ens have been appointment"}
	ErrIdempotent          = ErrInfo{ErrCode: 911, ErrMsg: "idempotent"}
	ErrOrderExpired        = ErrInfo{ErrCode: 912, ErrMsg: "order expired"}
	ErrChainUp             = ErrInfo{ErrCode: 913, ErrMsg: "chain up"}
	ErrPushSpaceArticleDir = ErrInfo{ErrCode: 914, ErrMsg: "not sufficient funds"}
)
