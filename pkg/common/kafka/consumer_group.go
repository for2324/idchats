...
func NewConsumerGroup(groupID string, sconfig *sarama.Config) (sarama.ConsumerGroup, error) {
	return sarama.NewConsumerGroup(config.Config.Kafka.Addr, groupID, sconfig)
}
