...
func (s *cacheServer) GetFollowEachOtherFriendIDListFromCache(ctx context.Context, req *pbCache.GetFollowEachOtherFriendIDListFromCacheReq) (resp *pbCache.GetFollowEachOtherFriendIDListFromCacheResp, err error) {
	//TODO implement me
	log.NewInfo(req.OperationID, utils.GetSelfFuncName(), "req: ", req.String())
	resp = &pbCache.GetFollowEachOtherFriendIDListFromCacheResp{CommonResp: &pbCache.CommonResp{}}
	friendIDList, err := rocksCache.GetFollowEachOtherFromCache(req.UserID)
	if err != nil {
		log.NewError(req.OperationID, utils.GetSelfFuncName(), err.Error())
		log.NewError(req.OperationID, utils.GetSelfFuncName(), "GetFollowEachOtherFriendIDListFromCache", err.Error())
...
func (s *cacheServer) DelFollowEachOtherFriendIDListFromCache(ctx context.Context, req *pbCache.DelFollowEachOtherFriendIDListFromCacheReq) (resp *pbCache.DelFollowEachOtherFriendIDListFromCacheResp, err error) {
	//TODO implement me
	log.NewInfo(req.OperationID, utils.GetSelfFuncName(), "req: ", req.String())
	resp = &pbCache.DelFollowEachOtherFriendIDListFromCacheResp{CommonResp: &pbCache.CommonResp{}}
	if err := rocksCache.DelFollowFriendIDListFromCache(req.UserID); err != nil {
