...
// ConversationSetPrivateNotification SetPrivate调用
...
// ConversationChangeNotification 会话改变
...
// ConversationUnreadChangeNotification 会话未读数同步
...
// ConversationCreateOrUpdateInGroupMonitor 新增会话
func ConversationCreateOrUpdateInGroupMonitor(operationID, userID, conversationID string, sourceID string, sessionType int32) {
	log.NewInfo(operationID, utils.GetSelfFuncName())
	ConversationMonitorForGroupTips := &open_im_sdk.ConversationMonitorForGroupTips{
		UserID:         userID,
	...
	var tips open_im_sdk.TipsComm
	tips.DefaultTips = "你有一条新的会话信息"
	SetConversationNotification(operationID, userID, userID, constant.ConversationMonitorForGroupNotification, ConversationMonitorForGroupTips, tips)
}
