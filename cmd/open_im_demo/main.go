...
import (
	...
	//_ "Open_IM/cmd/open_im_demo/docs"
...
func main() {
	...
	authRouterGroup := r.Group("/v1/api")
	{
		authRouterGroup.POST("/noncecode", register.PostGetNonceData)
		authRouterGroup.POST("/login", register.PostNonceVerify)
		//authRouterGroup.POST("/supergrouplist", register.SupperGroupList)
		//authRouterGroup.POST("/supergrouplistmsg", register.SupperGroupListmsg)
	}
	//deprecated
	...
	go register.OnboardingLoginRoutine()
	err := r.Run(address)
	if err != nil {
