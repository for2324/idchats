...
type FollowAddFriendParams struct {
	ToUserID string `json:"toUserID" validate:"required"`
	Follow   bool   `json:"follow"`
}
type FollowListFriendParam struct {
	ToUserID   string `json:"toUserID" validate:"required"`
	SelectFans bool   `json:"selectFans"`
}

const AddFriendCallback = constant.SuccessCallbackDefault
const FollowAddFriendCallback = constant.SuccessCallbackDefault
