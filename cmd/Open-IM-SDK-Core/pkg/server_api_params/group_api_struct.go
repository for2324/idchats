...
type MonitorGroupReq struct {
	GroupID     string `json:"groupID" binding:"required"`
	OperationID string `json:"operationID" binding:"required"`
}
type MonitorGroupResp struct {
	CommResp
}
...
type GetCommunityChannelListReq struct {
	OperationID string `json:"operationID" binding:"required"`
	GroupID     string `json:"groupID" binding:"required"`
}

type GetCommunityChannelListResp struct {
	CommResp
	GroupChannelInfoList []*GroupChannelInfo      `json:"-"`
	Data                 []map[string]interface{} `json:"data"`
}
