...
type LocalGroup struct {
	...
	ParentGroupID          string `gorm:"column:parent_group_id;size:64" json:"parentGroupID"`
	ChatTokenCount         int64  `gorm:"column:chat_token_count;default:0" json:"chatTokenCount"`
}
type LocalMonitorGroup struct {
	LocalGroup
}
...
type LocalUser struct {
	...
	ShowBalance        int32  `gorm:"column:show_balance;default:1" json:"showBalance"`
	Chainid            int32  `gorm:"column:chainid" json:"chainid"`
	OpenAnnouncement   int32  `gorm:"column:open_announcement;default:0" json:"openAnnouncement"`
	TokenContractChain string `gorm:"column:token_contract_chain;" json:"tokenContractChain"`
}
...
type LocalChatLog struct {
	...
	AttachedInfo     string `gorm:"column:attached_info;type:varchar(1024)" json:"attachedInfo"`
	ChannelID        string `gorm:"column:channel_id;index:index_channel;type:char(128)" json:"channelID"`
	Ex               string `gorm:"column:ex;type:varchar(1024)" json:"ex"`
}
...
type LocalConversation struct {
	...
	AttachedInfo          string `gorm:"column:attached_info;type:varchar(1024)" json:"attachedInfo"`
	ChannelID             string `gorm:"column:channel_id;type:char(128)" json:"channelID"`
	Ex                    string `gorm:"column:ex;type:varchar(1024)" json:"ex"`
}
