...
func (d *DataBase) initDB() error {
	...
	monitorGroup := &model_struct.LocalMonitorGroup{}
	...
	db.Table(constant.MonitorGroupTableName).AutoMigrate(monitorGroup)
