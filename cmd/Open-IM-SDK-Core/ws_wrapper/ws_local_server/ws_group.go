...
func (g *GroupCallback) OnGroupChannelInfoAdded(groupInfo string) {
	SendOneUserMessage(EventData{cleanUpfuncName(runFuncName()), 0, "", groupInfo, "0"}, g.uid)
}

func (g *GroupCallback) OnGroupChannelInfoDelete(groupInfo string) {
	SendOneUserMessage(EventData{cleanUpfuncName(runFuncName()), 0, "", groupInfo, "0"}, g.uid)
}

func (g *GroupCallback) OnGroupChannelInfoUpdate(groupInfo string) {
	SendOneUserMessage(EventData{cleanUpfuncName(runFuncName()), 0, "", groupInfo, "0"}, g.uid)
}
...
func (wsRouter *WsFuncRouter) SubscribeGroupChannel(input, operationID string) {
	m := make(map[string]interface{})
	if err := json.Unmarshal([]byte(input), &m); err != nil {
		log.Info(operationID, utils.GetSelfFuncName(), "unmarshal failed", input, err.Error())
		wsRouter.GlobalSendMessage(EventData{cleanUpfuncName(runFuncName()), StatusBadParameter, "unmarshal failed", "", operationID})
	...
	//callback common.Base, groupID, reqMsg string, operationID string
	userWorker.Group().SubscribeGroupChannel(&BaseSuccessFailed{runFuncName(), operationID, wsRouter.uId},
		m["groupID"].(string), operationID)
}

func (wsRouter *WsFuncRouter) UnSubscribeGroupChannel(input, operationID string) {
	m := make(map[string]interface{})
	if err := json.Unmarshal([]byte(input), &m); err != nil {
		log.Info(operationID, utils.GetSelfFuncName(), "unmarshal failed", input, err.Error())
		wsRouter.GlobalSendMessage(EventData{cleanUpfuncName(runFuncName()), StatusBadParameter, "unmarshal failed", "", operationID})
	...
	//callback common.Base, groupID, reqMsg string, operationID string
	userWorker.Group().UnSubscribeGroupChannel(&BaseSuccessFailed{runFuncName(), operationID, wsRouter.uId},
		m["groupID"].(string), operationID)
}
...
func (wsRouter *WsFuncRouter) GetJoinedGroupList(input, operationID string) {
	...
	userWorker.Group().GetJoinedGroupList(&BaseSuccessFailed{runFuncName(),
		operationID, wsRouter.uId}, operationID)
}
func (wsRouter *WsFuncRouter) GetGroupChannelList(inputGroupID, operationID string) {
	userWorker := open_im_sdk.GetUserWorker(wsRouter.uId)
	if !wsRouter.checkResourceLoadingAndKeysIn(userWorker, inputGroupID, operationID, runFuncName(), nil) {
		return
	}
	userWorker.Group().GetGroupChannelList(&BaseSuccessFailed{runFuncName(), operationID, wsRouter.uId}, inputGroupID, operationID)
}
...
func (wsRouter *WsFuncRouter) GetGroupMemberListFromServer(input, operationID string) {
	m := make(map[string]interface{})
	if err := json.Unmarshal([]byte(input), &m); err != nil {
		log.Info(operationID, utils.GetSelfFuncName(), "unmarshal failed", input, err.Error())
		wsRouter.GlobalSendMessage(EventData{cleanUpfuncName(runFuncName()), StatusBadParameter, "unmarshal failed", "", operationID})
	...
	userWorker.Group().GetGroupMemberListFromServer(&BaseSuccessFailed{runFuncName(), operationID, wsRouter.uId},
...
func (wsRouter *WsFuncRouter) MonitorGroupMessage(input, operationID string) { //(groupId string, userList string, callback Base) {
	m := make(map[string]interface{})
	if err := json.Unmarshal([]byte(input), &m); err != nil {
		log.Info(operationID, utils.GetSelfFuncName(), "unmarshal failed", input, err.Error())
		wsRouter.GlobalSendMessage(EventData{cleanUpfuncName(runFuncName()), StatusBadParameter, "unmarshal failed", "", operationID})
	...
	userWorker.Group().MonitorGroupMessage(&BaseSuccessFailed{runFuncName(), operationID, wsRouter.uId},
		m["groupID"].(string), operationID)
}
