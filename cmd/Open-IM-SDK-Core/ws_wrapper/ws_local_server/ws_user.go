...
func (u *UserCallback) OnSelfScoreInfoUpdated(userScore string) {
	SendOneUserMessage(EventData{cleanUpfuncName(runFuncName()), 0, "", userScore, "0"}, u.uid)
}
func (u *UserCallback) OnUserOrderPay(payInfo string) {
	SendOneUserMessage(EventData{cleanUpfuncName(runFuncName()), 0, "", payInfo, "0"}, u.uid)
}
func (u *UserCallback) OnUserGlobalAnnouncement(announcement string) {
	SendOneUserMessage(EventData{cleanUpfuncName(runFuncName()), 0, "", announcement, "0"}, u.uid)
}
