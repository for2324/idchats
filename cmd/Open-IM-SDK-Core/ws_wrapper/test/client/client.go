...
func (i *IMClient) GetFollowFriendApplicationList() error {
	return i.writeMessage(i.getWsReq("GetFollowFriendApplicationList", 0, sdk.FollowListFriendParam{
		ToUserID:   i.UserID,
		SelectFans: true,
	}))
}
...
func (i *IMClient) GetHistoryMessageList(groupId, channelId string) error {
	return i.writeMessage(i.getWsReq("GetHistoryMessageList", 0, sdk.GetHistoryMessageListParams{
		ChannelID: channelId,
		Count:     20,
		GroupID:   groupId,
	}))
...
func (i *IMClient) GetAdvancedHistoryMessageList(groupId, channelId string) error {
	return i.writeMessage(i.getWsReq("GetAdvancedHistoryMessageList", 0, sdk.GetAdvancedHistoryMessageListParams{
		ChannelID: channelId,
		Count:     20,
		GroupID:   groupId,
	}))
...
type SubscribeGroupChannelReq struct {
	GroupID string `json:"groupID"`
}

func (i *IMClient) SubscribeGroupChannel(groupId string) error {
	return i.writeMessage(i.getWsReq("SubscribeGroupChannel", 0, &SubscribeGroupChannelReq{GroupID: groupId}))
}
