...
func (l testFriendListener) OnFollowFriendApplicationAdded(friendApplication string) {
	//TODO implement me
	panic("implement me")
}

func (l testFriendListener) OnFollowFriendApplicationDeleted(friendApplication string) {
	//TODO implement me
	panic("implement me")
}
