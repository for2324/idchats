...
func (l testGroupListener) OnGroupChannelInfoAdded(groupInfo string) {
	//TODO implement me
	panic("implement me")
}

func (l testGroupListener) OnGroupChannelInfoDelete(groupInfo string) {
	//TODO implement me
	panic("implement me")
}

func (l testGroupListener) OnGroupChannelInfoUpdate(groupInfo string) {
	//TODO implement me
	panic("implement me")
}
