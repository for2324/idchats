...
func (m *SelfMsgSyncLatestModel) TriggerCmdNewMsgCome(msgList []*server_api_params.MsgData, operationID string, syncFlag int, currentMaxSeq uint32) {
	for {
		fmt.Println("SelfMsgSyncLatestModelSelfMsgSyncLatestModelSelfMsgSyncLatestModelSelfMsgSyncLatestModelSelfMsgSyncLatestModelSelfMsgSyncLatestModelSelfMsgSyncLatestModel")
